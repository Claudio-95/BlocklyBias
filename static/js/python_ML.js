...
(function (root, factory) {
    ...
    Blockly.Python.intersectionalBias = function (a) {
        ...
        var b = Blockly.Python.provideFunction_("check_intersectional_bias", [
            ...
            "        elem = elem.strip()",
            "\n",
            "    # Search columns sensible to bias",
            "    bias_df = []",
            "    for elem in dataset.columns:",
            ...
            "                bias_df.append(elem)",
            "\n",
            "    # Check if there are possible biased columns, if bias_df is empty return the final message, otherwise do the analysis",
            "    result = \"\"",
            "    if len(bias_df) == 0:",
            ...
            "        error_message = 0",
            "        for elem in dataset.columns:",
            "            for label in privileged_cols:",
            "                if label == elem:",
            "                    error_message = 1",
            "        if error_message == 1:",
            "            raise Exception(\"The specified privileged column is not present in the dataset\")",
            "\n",
            ...
            "        privilege_values = []",
            "        privilege_values.append(privileged_cols.values)",     //maybe it can calculate the ideal threshold to pass to privilege_values
