...
(function (root, factory) {
    ...
    Blockly.Python.intersectionalBias = function (a) {
        ...
        var b = Blockly.Python.provideFunction_("check_intersectional_bias", [
            ...
            "        dataset.dropna()",
            "\n",
            "    # Setting columns sensible to bias and privileged",
            ...
            "        data_copy = get_intersection(dataset, bias_cols[0], bias_cols[1])",
            "        cont_vars = []",
            "        for label in dataset_labels:",
            ...
            "        debias_params = get_debias_params()",
            "\n",
