...
(function (root, factory) {
    ...
    Blockly.Python.intersectionalBias = function (a) {
        ...
        var b = Blockly.Python.provideFunction_("check_intersectional_bias", [
            ...
            "            if (ind == i) or (is_string_dtype(dataset[biased_cols[ind]].dtype)) or (is_string_dtype(dataset[biased_cols[i]].dtype)):",
            "                pass",
            "            else:",
            "                attribute2_set = np.array(dataset[biased_cols[i]].unique()).tolist()",
            "                edf = get_edf_df(dataset, biased_cols[ind], biased_cols[i], attribute1_set, attribute2_set, privileged_cols)",
            "                edf_list.append(edf)",
