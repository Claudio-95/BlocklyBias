...
(function (root, factory) {
    ...
    Blockly.Python.intersectionalBias = function (a) {
        ...
        var b = Blockly.Python.provideFunction_("check_intersectional_bias", [
            ...
            "                dataset[new_privileged_cols] = dataset[privileged_cols].apply(to_num)   # .apply must be replaced with another method",
            ...
            "    privilege_values = dataset[privileged_cols].unique().tolist()",     //maybe it can calculate the ideal threshold to pass to privilege_values
