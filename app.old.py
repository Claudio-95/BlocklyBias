...
def save_notebook():
    ...
    for line in lines:
        ...
        if stripped_line and len(stripped_line.split()) == 1:
        ...
        elif stripped_line.startswith('#Markdown'):
            ...
            if code_block:
                ...
                notebook.cells.append(code_cell)
                code_block = []
            if stripped_line.startswith('EDF', 10, (len(stripped_line)-1)):
            ...
            elif stripped_line.startswith('Equal', 10, (len(stripped_line)-1)):
                ...
                markdown_cell = nbformat.v4.new_markdown_cell(markdown_code)
                notebook.cells.append(markdown_cell)
            elif stripped_line.startswith('Disparity', 10, (len(stripped_line)-1)):
                ...
                markdown_cell = nbformat.v4.new_markdown_cell(markdown_code)
                notebook.cells.append(markdown_cell)
            elif stripped_line.startswith('Ratio', 10, (len(stripped_line)-1)):
                markdown_code = f'\"Ratio between positive and negative outcomes:\"'
                markdown_cell = nbformat.v4.new_markdown_cell(markdown_code)
                notebook.cells.append(markdown_cell)
            elif stripped_line.startswith('Modal', 10, (len(stripped_line)-1)):
                markdown_code = f'\"Modal values:\"'
                markdown_cell = nbformat.v4.new_markdown_cell(markdown_code)
                notebook.cells.append(markdown_cell)
            elif stripped_line.startswith('Intersection', 10, (len(stripped_line)-1)):
                markdown_code = f'\"Intersection:\"'
                markdown_cell = nbformat.v4.new_markdown_cell(markdown_code)
                notebook.cells.append(markdown_cell)
            elif stripped_line.startswith('Positive', 10, (len(stripped_line)-1)):
                markdown_code = f'\"Positive income mode:\"'
                markdown_cell = nbformat.v4.new_markdown_cell(markdown_code)
                notebook.cells.append(markdown_cell)
            elif stripped_line.startswith('Negative', 10, (len(stripped_line)-1)):
                markdown_code = f'\"Negative income mode:\"'
                markdown_cell = nbformat.v4.new_markdown_cell(markdown_code)
                notebook.cells.append(markdown_cell)
            elif stripped_line.startswith('1stval', 10, (len(stripped_line)-1)):
                ...
                markdown_cell = nbformat.v4.new_markdown_cell(markdown_code)
                notebook.cells.append(markdown_cell)
            elif stripped_line.startswith('2ndval', 10, (len(stripped_line)-1)):
                ...
                markdown_cell = nbformat.v4.new_markdown_cell(markdown_code)
                notebook.cells.append(markdown_cell)
            elif stripped_line.startswith('1stoutcome', 10, (len(stripped_line)-1)):
                ...
                markdown_cell = nbformat.v4.new_markdown_cell(markdown_code)
                notebook.cells.append(markdown_cell)
            elif stripped_line.startswith('2ndoutcome', 10, (len(stripped_line)-1)):
                ...
                markdown_cell = nbformat.v4.new_markdown_cell(markdown_code)
                notebook.cells.append(markdown_cell)
            elif stripped_line.startswith('1stoutcomeneg', 10, (len(stripped_line)-1)):
                ...
                markdown_cell = nbformat.v4.new_markdown_cell(markdown_code)
                notebook.cells.append(markdown_cell)
            elif stripped_line.startswith('2ndoutcomeneg', 10, (len(stripped_line)-1)):
